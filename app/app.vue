...
// GitHub Pages sub-path 배포 대응: 정적 자산 href에 baseURL prepend
...
useHead({
  ...
  link: [
    ...
    {
      rel: 'stylesheet',
      href: 'https://fonts.googleapis.com/css2?family=Noto+Serif+KR:wght@300;400;500&family=JetBrains+Mono:wght@400;500;600&display=swap',
    },
  ],
  meta: [
